...
const HeroSection = memo(({ onGetStarted }: HeroSectionProps) => {
  return (
    <section className="pt-20 pb-8 relative overflow-hidden min-h-[75vh] max-[480px]:min-h-[auto] max-[480px]:pb-4">
      ...
      {/* Упрощённые декоративные элементы без тяжёлых анимаций */}
      <div className="absolute inset-0 opacity-20 pointer-events-none">
        <div className="absolute top-20 left-10 w-64 h-64 bg-neon-purple rounded-full blur-3xl"></div>
        <div className="absolute bottom-20 right-10 w-80 h-80 bg-neon-turquoise rounded-full blur-3xl"></div>
      </div>
      
      <div className="container mx-auto px-8 relative z-10">
        <div className="grid md:grid-cols-2 gap-12 items-center py-24 max-[480px]:py-12 max-[480px]:gap-6">
          <div className="space-y-4 md:pl-8 flex flex-col justify-center max-[480px]:text-center max-[480px]:space-y-3">
          ...
          <div className="flex justify-center md:justify-end items-center max-[480px]:mt-2">
        ...
        <div className="flex flex-col gap-4 justify-center items-center mt-12 max-[480px]:mt-6 max-[480px]:gap-3 w-full">
          <Button 
            ...
            style={{
              boxShadow: '0 0 15px rgba(179, 136, 235, 0.25), 0 8px 20px rgba(0, 0, 0, 0.2)'
            }}
          >
